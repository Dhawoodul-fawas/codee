...
# ---------------------------------------------------------
# Project CRUD using ModelViewSet (WITH SUCCESS MESSAGES)
# ---------------------------------------------------------
...
# ---------------------------------------------------------
# Filter by Status (ongoing / completed / not_started)
# ---------------------------------------------------------
class ProjectStatusFilterView(generics.ListAPIView):
    ...
    def get_queryset(self):
        ...
        return Project.objects.filter(project_status=status_param).order_by('-created_at')
...
class ProjectTypeFilterView(generics.ListAPIView):
    ...
    def get_queryset(self):
        ptype = self.kwargs.get('ptype')  # web, app, webapp
